...
assert_contains "patch handles variants from recommendation" "REC_VARIANT" "$patch_content"
assert_contains "patch logs recommendation reasoning" "Auto-select reasoning" "$patch_content"
